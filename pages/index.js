      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            { t:"Book & Remind", s:"Every trial or lesson gets scheduled and reminded — fewer no-shows." },
            { t:"On-Time Payments", s:"Billing stays clear, collected, consistent — no chasing checks." }
          ].map(({t,s})=>(
        ...
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-4 gap-6">
            {[
              ...
              {n:3,t:"AI Takes Over",s:"Your virtual staff reply, book, follow up, collect payments."},
        ...
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4" role="dialog" aria-modal="true">
          <div className="relative w-full max-w-3xl rounded-2xl bg-white p-4 shadow-2xl">
            ...
            <div id="ghl-calendar" className="mt-6">
              <iframe src="https://api.leadconnectorhq.com/widget/booking/moLbhpNSHi4Hd4YxkCLP"
                style={{width:"100%",height:"700px",border:"none"}} scrolling="no" title="Book a Call"/>
              <br/><script src="https://link.msgsndr.com/js/form_embed.js"/>
            </div>
          </div>
        </div>
      )}
