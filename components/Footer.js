      ...
      <div className="mx-auto grid max-w-7xl grid-cols-2 gap-10 px-6 py-16 sm:grid-cols-3 lg:grid-cols-6 lg:px-8">
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            <li><a href="#start" className="hover:text-white">Quickstart ($720/mo)</a></li>
            <li><Link href="/how-it-works" className="hover:text-white">Ops Bundle</Link></li>
            <li><Link href="/case-studies" className="hover:text-white">Case Studies</Link></li>
            <li><a href="#demo" className="hover:text-white">Book 15-min Demo</a></li>
          </ul>
        </div>
        <div>
